...
public class Pending_Checklist_Edit extends Fragment  {
    @BindView(R.id.back)
    ImageView back;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v= inflater.inflate(R.layout.fragment_pending_list_edit,container, false);
    ...
    private void Save(View view){
        ...
        txt_msg.setText("Your Checklist has been updated \n" +
                "     successfully");
